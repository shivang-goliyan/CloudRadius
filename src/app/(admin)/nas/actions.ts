...
export async function createNasDevice(formData: unknown): Promise<ActionResponse> {
  try {
    ...
    return { success: false, error: error instanceof Error ? error.message : "Failed to create NAS device" };
  }
}
...
export async function updateNasDevice(id: string, formData: unknown): Promise<ActionResponse> {
  try {
    ...
    return { success: false, error: error instanceof Error ? error.message : "Failed to update NAS device" };
  }
}
...
export async function deleteNasDevice(id: string): Promise<ActionResponse> {
  try {
    ...
    return { success: false, error: error instanceof Error ? error.message : "Failed to delete NAS device" };
  }
}
